...
slr_result_Beta0 <- slr_result$Beta0
slr_result_Beta1 <- slr_result$Beta1


all.equal(slr_result_Beta0, lm_intercept, check.attributes = FALSE)
all.equal(slr_result_Beta1, lm_slope, check.attributes = FALSE)
```
